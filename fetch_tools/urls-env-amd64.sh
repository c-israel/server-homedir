...
# contains binary
CURL_URL="https://github.com/stunnel/static-curl/releases/download/8.16.0/curl-linux-x86_64-musl-8.16.0.tar.xz"
...
TMUX_URL="https://github.com/mjakob-gh/build-static-tmux/releases/download/v3.5e/tmux.linux-amd64.gz"
