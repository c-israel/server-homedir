...
* [neovim](https://github.com/neovim/neovim/) 
  [v0.11.4](https://github.com/neovim/neovim/releases/tag/v0.11.4)
  [Apache 2.0 / Vim License](https://github.com/neovim/neovim/blob/v0.11.4/LICENSE.txt)
  (text editor)
...
* [static-curl](https://github.com/stunnel/static-curl/)
  [8.16.0](https://github.com/stunnel/static-curl/releases/tag/8.16.0)
  [MIT License](https://github.com/stunnel/static-curl/blob/8.16.0/LICENSE) and [curl license](https://github.com/curl/curl/blob/curl-8_16_0/COPYING)
* [lnav](https://github.com/tstack/lnav/)
  [v0.13.2](https://github.com/tstack/lnav/releases/tag/v0.13.2)
  [BSD 2-Clause "Simplified" License](https://github.com/tstack/lnav/blob/v0.13.2/LICENSE)
  (log file viewer)
...
* [tmux](https://github.com/tmux/tmux)
  ...
  / [3.5e](https://github.com/mjakob-gh/build-static-tmux/releases/tag/v3.5e)
